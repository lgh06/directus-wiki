...
To create a custom data workflow for your users, create permissions specific to status states. This will allow you to restrict what status options are available to users, from other status states.